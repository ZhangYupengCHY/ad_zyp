...
# 远程文件请求路径
SAVEFOLDER = r"F:\chujin_five_reports\remote_get_five_files"
# 压缩文件保存路径
STATIONSZIPFOLDER  = r"F:\five_reports_zipped"

def request_cj_amazon_account(start_day=5, end_day=14):
    """
        每日请求的楚晋的站点列表
    """
    ...
    cjAmazonAccount = process_company.Company("楚晋").station()

    # 每日需要请求的楚晋站点
    return list(allAdAccount & cjAmazonAccount)
...
def request_ac_file(key_path=r"E:\ad_zyp\api_request_files\public.key"):
    ...
    cjAmazonAccountDailyRequest = request_cj_amazon_account(start_day=5, end_day=14)
...
def request_cp_br_st_reports():
    ...
    def request_reports_log():
        ...
        for fileType, remoteFileTypeSaveName in remoteReportsNameDict.items():
            ...
            # 日志保存文件夹
            logFolderName = 'log'
            logSaveBaseName = f'cx_{fileType}.xlsx'
    ...
    def redis_store_report_remote_path():
        ...
        filesSaveBasenameList = ['cx_cp.xlsx', 'cx_br.xlsx', 'cx_st.xlsx']
        ...
        cxFolderFirstDegree = '/shujubaobiao/report_new/erp_report'
        #
...
def process_cj_reports(ac_ao_start_hour=20, st_br_cp_start_hour=8):
    """
    楚晋请求五表
    ac/ao
    br/st/cp
