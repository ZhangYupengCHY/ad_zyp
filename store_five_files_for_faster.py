    ...
    while 1:
        try:
            ...
            if refresh_before_hour is None:
                ...
                # todo 处理某个站点
                testStation = 'Founen_US'.upper()
                needed_process_station_zip_namelist = [path for path in needed_process_station_zip_namelist if testStation in path]
...
if __name__ == "__main__":
    ...
    refresh_folder(zipped_folder,refresh_before_hour=280)
